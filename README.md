...
Os requests contendo os itens a serem adicionados e configurados na base de dados estão alocados no arquivo: [a link](https://github.com/EdsonPrates-des/solr-search-engine/blob/master/other_file.md)
