...
Os requests e json contendo os itens a serem adicionados na base de dados ficarão alocados nos seguintes arquivos:

Quais os passos para realizar a execução?
